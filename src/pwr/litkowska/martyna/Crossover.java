...
public class Crossover {
    ...
    public List<Genotype> crossGenotypes(Genotype genotype1, Genotype genotype2, List<Genotype> newGenotypes){
...
//            genotype2.getGenotype().get(index-i).setValue(g1.get(0).getValue());
        ...
        if (gen1!=null) newGenotypes.add(new Genotype(gen1));
        if (gen2!=null) newGenotypes.add(new Genotype(gen2));
        return newGenotypes;
    }
}
